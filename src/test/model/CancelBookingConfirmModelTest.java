...
class CancelBookingConfirmModelTest {
    ...
    @Test
    void deleteBookingRecord() throws SQLException {
        assertEquals(true, cancelBookingConfirmModel.deleteBookingRecord(77777, "2021-05-20"),
                "we have employee id 77777 booked in 2021-05-20 in the database, expected true");
    }

    @Test
    void deleteBookingRecordWithIncorrectID() throws SQLException {
        assertEquals(false, cancelBookingConfirmModel.deleteBookingRecord(00000, "2021-05-20"),
                "we don't have employee id 00000 booked in 2021-05-20 in the database, expected false");
    }

    @Test
    void deleteWhitelistRecord() throws SQLException {
        assertEquals(true, cancelBookingConfirmModel.deleteWhitelistRecord(77777, "2021-05-20"),
                "we have employee id 77777 booked in 2021-05-21 in the database (method auto add 1 day), expected true");
    }

    @Test
    void deleteWhitelistRecordWithIncorrectID() throws SQLException {
        assertEquals(false, cancelBookingConfirmModel.deleteWhitelistRecord(00000, "2021-05-20"),
